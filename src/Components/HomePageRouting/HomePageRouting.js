...
const HomePageRoutingComponent = () => {
  const routes = [
    { header: 'Vote', listItems: ['Register to vote', 'Check my voter registration', 'Find a polling place near me'], linksTo: ['/register-to-vote', '/check-my-registration', '/find-polling-place'] },
