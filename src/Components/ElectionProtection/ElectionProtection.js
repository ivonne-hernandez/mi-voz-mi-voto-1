    ...
    <div className="election-protection-container">
      ...
      <article className="article-content">
        <ol>
          ...
          <li className="list-item">
            <FormattedMessage
              id="electionProtection.listItem4"
              defaultMessage="Try your best to vote on a regular ballot. Only cast a provisional ballot if you don't have any other option. Unfortunately, many states will not count a provisional ballot if it was casted at the wrong polling location." />
          </li>
          <li className="list-item">
            <FormattedMessage
              id="electionProtection.listItem5"
              defaultMessage="If any issues arise at the polling site do your best to resolve them then and there. Keep in mind that most poll workers are genuinely trying their best, but they're human too and humans sometimes make mistakes." />
          </li>
        </ol>
      </article>
    </div>
